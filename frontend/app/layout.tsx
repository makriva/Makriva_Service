...
export const metadata: Metadata = {
  ...
  keywords: [
    'makhana', 'phool makhana', 'fox nuts', 'lotus seeds', 'foxnuts',
    'premium makhana', 'healthy makhana', 'raw makhana', 'roasted makhana',
    'dry roasted makhana', 'flavoured makhana', 'organic makhana',
    'buy makhana online', 'makhana online india', 'order makhana online',
    'healthy snacks india', 'high protein snacks', 'low calorie snacks',
    'natural snacks', 'gluten free snacks', 'vegan snacks india',
    'Bihar makhana', 'Darbhanga makhana', 'makhana snack',
    'makriva', 'makriva makhana',
  ],
