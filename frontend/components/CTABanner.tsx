  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-400 mb-8 max-w-lg mx-auto">Stock up on your favourite MakRiva makhana and enjoy free delivery straight to your doorstep across India.</p>
